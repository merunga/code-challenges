...
it('', () => expect(almostIncreasingSequence([1, 2, 1, 2])).toBe(false));
it('', () => expect(almostIncreasingSequence([3, 6, 5, 8, 10, 20, 15])).toBe(false));
it('', () => expect(almostIncreasingSequence([1, 1, 2, 3, 4, 4])).toBe(false));
it('', () => expect(almostIncreasingSequence([1, 4, 10, 4, 2])).toBe(false));
it('', () => expect(almostIncreasingSequence([0, -2, 5, 6])).toBe(true));
